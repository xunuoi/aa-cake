var LinedTextArea = function(parentWrapper) {
    ...
    var cssCanvas = 'border: 0; margin:0; padding:0;';
    var cssTextArea =  'width:100%; height: 100%;'
                    + `font-size: ${fontSize}px;`
                    + 'font-family: ProximaNova,Helvetica,Arial,sans-serif;'
                    // FIXME: Fix line-height for area, should be 18px
                    + 'line-height:19px;'
    ...
    ta.paintLineNumbers = function() {
        ...
        try {
            ...
            ctx.fillStyle = "#BBB";
            ctx.font = `${fontSize}px ProximaNova,Helvetica,Arial,sans-serif`; // NOTICE: must match TextArea font-size and line-height
            ...
            const paddingTop = (lineHeight - fontSize)/2;
